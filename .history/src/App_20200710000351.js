          ...
          <ul className="courses-list">
            <li className="courses-sci">
              <div className="sci-figure">
                <img src="/svc/coursecover/4307" alt="Демо-версия" />
              </div>
              <div className="sci-info">
                ...
                <p className="sci-controls">
                            <a href="#" onclick="_try(4307, 'Демо-версия. Примеры ЭОР для работы за компьютером', 'demo')" className="pure-button pure-button-primary btn-fluid">Попробовать</a>
