            ...
            <div className="courses-filters">
                <form>
                    <div className="row">
                        ...
                        <div className="col-md">
                            <div className="form-group">
                                <input className="form-control" type="text" placeholder="Поиск" id="search" name="search" onChange={(e) => this.onSearchChange(e)} onKeyUp={(e) => this.(e) => this.onSearchChange(e)(e)} />
                            </div>
                        </div>
                        <div className="col-md">
