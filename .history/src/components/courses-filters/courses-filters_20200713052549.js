                        ...
                        <div className="col-md">
                            <div className="dropdown">
                                ...
                                <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div className="dropdown-item" href="#" onClick={(e) => this.props.changePrice('RUB')}>Рубли</div>
                                    <div className="dropdown-item" href="#" onClick={(e) => this.props.changePrice('BONUS')}>Бонусы</div>
                                </div>
                            </div>
                        </div>
                    </div>
