                        ...
                        <div className="col-md">
                            <div className="dropdown">
                                ...
                                <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div className="dropdown-item active" href="#" onClick={() => this.onChange(e, 'RUB')}>Рубли</div>
                                    <div className="dropdown-item" href="#" onClick={() => this.onChange(e, 'BONUS')}>Бонусы</div>
                                </div>
                            </div>
                        </div>
                    </div>
