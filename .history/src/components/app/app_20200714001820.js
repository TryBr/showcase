...
export default class App extends Component {
  ...
  onChangeFilter = (type, filter) => {
    ...
    //   const coursesDataNew = this.state.coursesData;
    //   this.setState({
    //     coursesDataFiltered: coursesDataNew,
    //     isFiltered: false
    //   });
    // }
    ...
    if (filter === 'DEFAULT') {
      ...
      switch(type) {
        case 'subject':       
            ...
            let genresNew = coursesData.map(item => item.genre);
            let genresFilteredNew = genresNew.filter((item, index) => genresNew.indexOf(item) === index);
            this.setState({
              coursesDataFiltered: coursesData,
              isFiltered: true,
              genres: genresFilteredNew
            });
            break;
