...
export default class App extends Component {
  ...
  onChangeFilter = (type, filter) => {
    ...
    if (filter === 'DEFAULT') {
      ...
      switch(type) {
        case 'subject':       
            coursesData = coursesData.filter(item => item.subject.toLowerCase() === this.state.filterSubject.toLowerCase());
            this.setState({
              coursesDataFiltered: coursesData,
              isFiltered: true
            });
        ...
        case 'genre': 
            coursesData = coursesData.filter(item => item.genre.toLowerCase() === this.state.genre.toLowerCase());
            this.setState({
              coursesDataFiltered: coursesData,
              isFiltered: true
            });
        ...
        case 'grade':
            coursesData = coursesData.filter(item => item.grade.toLowerCase() === this.state.grade.toLowerCase());
            this.setState({
              coursesDataFiltered: coursesData,
              isFiltered: true
            });
